...
from . import utils, xl, xltypes, xlerrors
...
@xl.validate_args
def DATE(
        year: xltypes.XlNumber,
        month: xltypes.XlNumber,
        day: xltypes.XlNumber
) -> xltypes.XlDateTime:
...
@xl.validate_args
def YEARFRAC(
        start_date: xltypes.XlDateTime,
        end_date: xltypes.XlDateTime,
        basis: xltypes.XlNumber = 0
) -> xltypes.XlNumber:
