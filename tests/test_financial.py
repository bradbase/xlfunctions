...
from xlfunctions import xl, xlerrors, xltypes, date, financial
...
class FinancialModuleTest(unittest.TestCase):
    ...
    def test_NPV(self):
        ...
        range1 = xltypes.Array([[8000, 9200, 10000, 12000, 14500]])
        self.assertAlmostEqual(
    ...
    def test_XNPV(self):
        range_00 = xltypes.Array(
            [[-10000, 2750, 4250, 3250, 2750]])
        range_01 = xltypes.Array([[
            date.DATE(2008, 1, 1),
            date.DATE(2008, 3, 1),
