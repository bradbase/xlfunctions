...
from xlfunctions import xl, xlerrors, xltypes
...
class XlModuleTest(unittest.TestCase):
    ...
    def test_validate_args_with_list(self):
        ...
        @xl.validate_args
        def func(*args: typing.List[xltypes.XlNumber]):
            return args
    ...
    def test_validate_args_with_union(self):
        ...
        @xl.validate_args
        def func(arg: typing.Union[xltypes.XlNumber, xltypes.XlText]):
            return arg
    ...
    def test_validate_args_with_union_and_bad_value(self):
        ...
        @xl.validate_args
        def func(arg: typing.Union[xltypes.XlNumber, xltypes.XlDateTime]):
            return arg
