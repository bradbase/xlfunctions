...
from xlfunctions import text, xl, xlerrors, xltypes
...
class TextModuleTest(unittest.TestCase):
    ...
    def test_CONCAT(self):
        ...
        self.assertEqual(
            text.CONCAT("SPAM", " ", xltypes.Array([[1, 2]]), 4), 'SPAM 124')

    def test_CONCAT_with_too_many_items(self):
        self.assertIsInstance(text.CONCAT(*[0]*300), xlerrors.ValueExcelError)
