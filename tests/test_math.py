...
class DateModuleTest(unittest.TestCase):
    ...
    def test_SUM(self):
        self.assertEqual(math.SUM(xltypes.Array([[1, 2], [3, 4]])), 10)
    ...
    def test_SUMPRODUCT_ranges_with_errors(self):
        range1 = xltypes.Array([[xlerrors.NumExcelError('err')], [10], [3]])
        range2 = xltypes.Array([[3], [3], [1]])
        self.assertIsInstance(
